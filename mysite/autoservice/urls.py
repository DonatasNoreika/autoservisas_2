...
urlpatterns = [
    ...
    path('myorders/<int:pk>/update', views.UserOrderUpdateView.as_view(), name='my-order-update'),
    path('myorders/<int:pk>/delete', views.UserOrderDeleteView.as_view(), name='my-order-delete'),
